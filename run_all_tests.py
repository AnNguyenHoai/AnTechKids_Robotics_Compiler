...
def main()->int:
    ...
    tests.append(ROOT/"tests"/"b2_4"/"run_b2_4.py"); tests.append(ROOT/"tests"/"b2_4"/"run_packaged_flash_boundary.py"); tests.append(ROOT/"tests"/"b2_5"/"run_b2_5.py"); tests.append(ROOT/"tests"/"b2_6"/"run_b2_6.py"); tests.append(ROOT/"tests"/"b2_7"/"run_b2_7.py"); tests.append(ROOT/"tests"/"b2_7"/"run_firmware_source_transients.py"); tests.append(ROOT/"tests"/"h29_runtime"/"run_h29_runtime.py"); tests.append(ROOT/"tests"/"h30_multi_robot"/"run_h30_multi_robot.py"); tests.append(ROOT/"tests"/"h31_boolean"/"run_h31_boolean.py"); tests.append(ROOT/"tests"/"h32_platform_contract"/"run_h32_platform_contract.py"); tests.append(ROOT/"tests"/"h33_capability_compiler"/"run_h33_capability_compiler.py"); tests.append(ROOT/"tests"/"h34_contract_traceability"/"run_h34_contract_traceability.py"); tests.append(ROOT/"tests"/"h35_compatibility"/"run_h35_compatibility.py"); tests.append(ROOT/"tests"/"ui_responsive"/"run_ui_responsive.py"); tests.append(ROOT/"tests"/"ui_production"/"run_ui_production.py"); tests.append(ROOT/"tests"/"line_follow_stability"/"run_line_follow_stability.py"); tests.append(ROOT/"tests"/"vm_responsiveness"/"run_vm_responsiveness_baseline.py"); tests.append(ROOT/"tests"/"vm_responsiveness"/"run_run_slice_core.py")
