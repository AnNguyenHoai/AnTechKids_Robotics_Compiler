...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="rsd-21-8-") as td:
        ...
        dist=base/"dist"
        result=production_distribution.build_production_distribution(production_distribution.ProductionDistributionInputs(exe,resources,inputs/"VERSION",compiler_root,frontend_root),dist)
