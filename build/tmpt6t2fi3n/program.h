...
const Instruction generatedProgram[] =
{
    ...
    Instruction(Opcode::LoadConst, 1, 70, 0, 0),
    ...
    Instruction(Opcode::LoadConst, 14, 25, 0, 0),
    ...
    Instruction(Opcode::JumpIfFalse, 12, 42, 0, 0),
...
const uint16_t generatedProgramSize = 43;
