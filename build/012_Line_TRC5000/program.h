...
{
    Instruction(Opcode::LoadConst, 1, 2, 0),
    Instruction(Opcode::ReadLine, 1, 2, 0),
    Instruction(Opcode::Store, 2, 0, 0),
    Instruction(Opcode::JumpIfFalse, 0, 10, 0),
    Instruction(Opcode::LoadConst, 3, 80, 0),
    ...
    Instruction(Opcode::LoadConst, 5, 80, 0),
