...
def _cmd_build(a):
    try:r=production_release_assembly.assemble_release(production_release_assembly.ProductionReleaseInputs(a.executable,a.runtime_resources,a.version_file,production_release_assembly._source_revision(a.source_revision),a.runtime_bin,a.runtime_platformio,a.compiler_root,a.frontend_root,a.firmware_root),a.output)
