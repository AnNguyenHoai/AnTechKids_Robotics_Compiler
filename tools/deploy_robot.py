...
def deployment_environment(project_name:str)->dict[str,str]:
 # RSD-11 contract: materialize the writable build workspace before resolving
 # the deployment environment so PlatformIO can never fall back to source-tree state.
